...
%MSBUILD_PATH% build.proj /nologo /verbosity:n /t:Package /p:Configuration=Release;DeployTarget="%DEPLOYMENT_TARGET%";DeploySource=%DEPLOYMENT_SOURCE%;DeployTemp=%DEPLOYMENT_TEMP%
::
