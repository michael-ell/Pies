...
namespace Codell.Pies.Web.Routing
{
    public class RouteBuilder
    {
        ...
        {
            routes.MapRoute("", "home/page/{page}", new { controller = "Home", action = "Index" }, new[] { typeof(HomeController).Namespace });
            routes.MapRoute("", "home/find/{tag}", new { controller = "Home", action = "Find" }, new[] { typeof(HomeController).Namespace });
