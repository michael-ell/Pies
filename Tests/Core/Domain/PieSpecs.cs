...
namespace Codell.Pies.Tests.Core.Domain.PieSpecs
{
    ...
    [Concern(typeof(Pie))]
    public class When_adding_the_first_ingredient : AggregateRootSpecBase<Pie>
    {
    ...
    [Concern(typeof(Pie))]
    public class When_an_ingredient_is_added_that_is_not_the_first_ingredient : AggregateRootSpecBase<Pie>
    {
        private string _description;
